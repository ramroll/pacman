...
params = {
    # Model backups
    'load_file': 'model-partial_57656_1653.data-00000-of-00001',
    'save_file': 'partial',
    'save_interval' : 10000, 
...
class DQNAgent:
    def __init__(self, player, args):
        ...
        print("Initialise DQN Agent", args)

        self.player = player
        # Load parameters from user-given arguments
        self.params = params
        self.params['width'] = args['layout'].width
        self.params['height'] = args['layout'].height
    ...
    def observation_step(self, state):
        if self.last_action is not None:
            ...
            self.current_score = state.pacmanScore if self.player.isPacman else state.ghostScorec
